...
public class Farmacia
{
    ...
    private Cliente.ClienteHelado[] cliente1;
    private Cliente.ClienteCosmeticos[] cliente2;
    private Cliente.ClienteMedicamento[] cliente3;  
    ...
    public Farmacia(String nit,String nombreFarmacia,String direccion){
        ...
        cliente1 = new Cliente.ClienteHelado[50];
        cliente2 = new Cliente.ClienteCosmeticos[50];
        cliente3 = new Cliente.ClienteMedicamento[50];        
        numClientes1 = 0;
        numClientes2 = 0;
        numClientes3 = 0;        
    }
    ...
    public void adicionarClienteHelado(String identificacion, String nombre, String sucursal, double compra1, double compra2){
        cliente1[numClientes1] = new Cliente.ClienteHelado(identificacion, nombre, sucursal, compra1, compra2);
        numClientes1++;
    }
    ...
    public void adicionarClienteCosmeticos(String identificacion, String nombre, String sucursal, double compra1, double compra2, double compra3){
        cliente2[numClientes2] = new Cliente.ClienteCosmeticos(identificacion, nombre, sucursal, compra1, compra2, compra3);
        numClientes2++;
    }
    ...
    public void adicionarClienteMedicamento(String identificacion, String nombre, String sucursal, double compra1, double compra2, double compra3, double compra4){
        cliente3[numClientes3] = new Cliente.ClienteMedicamento(identificacion, nombre, sucursal, compra1, compra2, compra3, compra4);
        numClientes3++;
    }
}
